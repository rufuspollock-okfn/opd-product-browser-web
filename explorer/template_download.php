    ...
    <tr>
        <td>
             <ul>
                ...
                <li><b>POD Database - Dump</b> gzipped SQL file (MySQL) 2014.01.01 v1 :&nbsp;<a href="docs/pod_web_2014.01.01_01.sql.gz" target="_blank" rel="nofollow">Direct download</a> <br/>Use WAMP (www.wampserver.com) and Bigdump (www.ozerov.de/bigdump/) to load the database.</li>
