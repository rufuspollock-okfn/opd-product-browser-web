...
<ul>
  <li><a href="pss-specification#whatIsPss">What is PSS?</a></li>
  <li><a href="pss-specification#sampleFiles">Sample files</a></li>
  <li><a href="pss-specification#aboutThisDocument">About this document</a></li>
  <li><a href="pss-specification#requiredManufacturerElements">Required manufacturer elements</a></li>
  <li><a href="pss-specification#optionalManufacturerElements">Optional manufacturer elements</a></li>
  <li><a href="pss-specification#requiredBrandElements">Required Elements of &lt;brand></a></li>
  <li><a href="pss-specification#optionalBrandElements">Optional Elements of &lt;brand></a></li>
  <li><a href="pss-specification#requiredItemElements">Required Elements of &lt;item></a></li>
  <li><a href="pss-specification#optionalItemElements">Optional Elements of &lt;item></a></li>
  <li><a href="pss-specification#comments">Comments</a></li>
  <li><a href="pss-specification#extendingPss">Extending PSS</a></li>
  <li><a href="pss-specification#roadmap">Roadmap</a></li>
  <li><a href="pss-specification#licenseAndAuthorship">License and authorship</a></li>
</ul>
...
<p>At the top level, a PSS document is a &lt;pss&gt; element, with a mandatory attribute called version, that specifies the version of PSS that the document conforms to. If it conforms to this specification, the version attribute must be 0.02.</p>
...
<p>Here are sample files for: PSS <a href="http://www.product-open-data.com/docs/pss-sample-001.xml" target="_blank">0.02</a>.</p>

<h2>About this document<a name="aboutThisDocument"></a></h2>

<p>This document represents the current status of PSS anduse as a template the structure of the RSS 2.11 specification. Change notes are <a href="http://www.product-open-data.com/pss-change-notes" target="_blank">here</a>.</p>
